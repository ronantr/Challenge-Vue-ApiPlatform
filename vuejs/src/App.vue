...
<template>
        ...
        <div id="app" v-if="isAttempted">
            <nav class="bg-gray-900">
                <div class="container mx-auto flex items-center justify-between px-4 py-3">
                    <div class="flex">
                        <div class="ml-4">
                            <router-link to="/" class="text-white hover:text-gray-500">
                                <!-- TODO: revoir le logo dans la nav -->
                        ...
                        <div class="mt-2 ml-12 mx-5">
                            <router-link to="/about" class="text-white hover:text-gray-500 ml-4">À propos de nous
                            </router-link>
                        </div>
                        <div class="mt-2 mx-5">
                    ...
                    <div v-if="!isAuthenticated" class="ml-auto">
                        <div class="ml-4">
                            <router-link to="/register" class="text-white hover:text-gray-500">
                                <FontAwesomeIcon icon="user-plus" /> S'inscrire
                            </router-link>
                        </div>
                        <div class="ml-4">
    ...
    <footer class="px-4 divide-y bg-gray-800 text-gray-100" style=" bottom: 0; width: 100%;">
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <a rel="noopener noreferrer" href="/" class="flex justify-center space-x-3 lg:justify-start">
                    <div class="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                        <svg data-v-423bf9ae="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 337 90"
                            ...
                            <defs data-v-423bf9ae="">
                                <linearGradient data-v-423bf9ae="" gradientTransform="rotate(25)"
                                    id="529cf020-644b-460e-be69-2085fa83c783" x1="0%" y1="0%" x2="100%" y2="0%">
                                    <stop data-v-423bf9ae="" offset="0%"
                                        style="stop-color: rgb(24, 36, 113); stop-opacity: 1;"></stop>
                                    <stop data-v-423bf9ae="" offset="100%"
                                        style="stop-color: rgb(38, 100, 200); stop-opacity: 1;"></stop>
            ...
            <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                <div class="space-y-3">
                    <h3 class="tracking-wide uppercase dark:text-gray-50">Informations légales</h3>
                    <ul class="space-y-1">
                        <li>
                            <a rel="noopener noreferrer" href="/cgv">Conditions générales de vente</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="/privacypolicy">Politique de confidentialité</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="/legalnotices">Mentions legales</a>
                        </li>
                    </ul>
                </div>
                <div class="space-y-3">
                    <h3 class="tracking-wide uppercase dark:text-gray-50">Aide</h3>
                    <ul class="space-y-1">
                        <li>
        ...
        <div class="py-6 text-sm text-center dark:text-gray-400">© 2023 Theatly. Tous droit réservé.</div>
    </footer>
</template>
