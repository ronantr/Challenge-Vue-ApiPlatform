...
<template>
    ...
    <Transition>
                    ...
                    <div class="flex">
                        <div class="ml-4">
                            <router-link to="/" class="text-white hover:text-gray-500">
                                ...
                                Theatly<svg data-v-423bf9ae="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 337 90"
                                    class="nav-logo"><!---->
                        ...
                        <div class="float-right ml-4">
                            <router-link to="/cart" class="text-white hover:text-gray-500">
                                <font-awesome-icon icon="cart-shopping" /> Panier
                            </router-link>
                        </div>
     ...
     <!-- TODO: revoir footer fixe en bas : pb -->
